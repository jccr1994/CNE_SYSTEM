		...
		function Registrar(){
			...
			if(texttitulo!="" || textcedula!=""){
				...
				if(ext == "pdf" || ext == "docx" || ext == "doc"){
					...
					$("#seleccionararchivo").val("");
					Swal.fire('Mensaje De Advertencia',"Extensión no permitida: "+ext+"<br>Solo se permite archivos PDF, DOC, DOCX.","warning");
				}
			}else{
	...
	$(function () {
		...
		var hc_generarpdf = function(tbody, table){
			$(tbody).on("click", "a#btn_generarpdf", function(){
				...
				//alert(id_actualizar);
				Swal.fire('Contraseña',id_actualizar,"success");
			});
		}
		hc_generarpdf('#empTable', Table);
	});
